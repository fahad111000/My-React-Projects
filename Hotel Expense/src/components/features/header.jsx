        ...
        <Box borderBottom="1px solid" borderColor={'appBorder'} py={6} >
            ...
            <Flex justifyContent={'center'} align={'center'}>
                ...
                <Box textAlign={'center'} flex={2} >
                    <Text color={'appLogoColor'} hideFrom="print" fontSize={40}
                        fontWeight={'extrabold'} fontFamily={"-apple-system"} >Aryana Hotel</Text>
                </Box>
                <hr />

                {/* <Text size='lg' fontWeight={'bold'}>{managerShift}</Text> */}
